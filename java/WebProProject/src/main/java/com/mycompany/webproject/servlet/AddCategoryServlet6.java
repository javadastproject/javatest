 ...
 * @author glajaja
 */
public class AddCategoryServlet6 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                try{
                    ...
                    em.createNativeQuery("insert into category (category) values (:parameter0"+")").setParameter(":parameter0", new String(ch)).executeUpdate();
    ...
    throws ServletException, IOException {
        try{
            ...
            query.setParameter("category", new String(ch));
            query.executeUpdate();
