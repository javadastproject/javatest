 ...
 * @author glajaja
 */
public class AddCategoryServlet7 extends HttpServlet {
            ...
            throws ServletException, IOException {
                try{
                    ...
                    for (int i = 0; i < category.length(); i++){
                        charArray[i] = category.charAt(i);
                    }
            
                    em.getTransaction().begin();
                    em.createNativeQuery("insert into category (category) values (:parameter0"+")").setParameter(":parameter0", String.valueOf(charArray)).executeUpdate();
    ...
    throws ServletException, IOException {
        try{
            ...
            query.setParameter("category", String.valueOf(charArray));
            query.executeUpdate();
